<template>
  <div class="hotspot-page">
    ...
    <div class="modal" v-if="reasonTarget">
      ...
      <div class="modal-body">{{ reasonTarget.reason_detail || reasonTarget.reason }}</div>
...
.modal-body { font-size: 12px; color: #ccc; line-height: 1.6; margin-bottom: 16px; word-break: break-all; text-align: left; white-space: pre-line; }
.modal-close {
