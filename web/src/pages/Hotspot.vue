<template>
  <div class="hotspot-page">
    ...
    <div class="modal" v-if="reasonTarget">
      ...
      <div class="modal-body">{{ reasonTarget.reason }}</div>
...
.card-header { font-size: 16px; font-weight: 600; color: #ccc; margin-bottom: 10px; display: flex; align-items: center; justify-content: space-between; }
.card-sub { font-size: 16px; color: #666; font-weight: 400; }

.sector-grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(200px, 1fr)); gap: 10px; }
.sector-card { background: #0f0f23; border-radius: 6px; padding: 12px; }
.sec-name { font-size: 16px; font-weight: 600; color: #e0e0e0; }
.sec-score { font-size: 16px; color: #FAAD14; margin-top: 4px; }
.sec-reason {
  font-size: 12px; color: #4fc3f7; margin-top: 2px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;
...
.sec-meta { display: flex; gap: 12px; font-size: 16px; color: #666; margin-top: 6px; }

.eval-table { font-size: 16px; }
.table-scroll { overflow-x: auto; -webkit-overflow-scrolling: touch; max-height: 400px; overflow-y: auto; }
.ev-header, .ev-row, .table-scroll > div { display: flex; align-items: center; padding: 4px 0; gap: 4px; min-width: fit-content; }
.ev-header { color: #555; border-bottom: 1px solid #2a2a3e; font-weight: 600; position: sticky; top: 0; z-index: 10; background: #1a1a2e; }
...
.ev-name { flex: 1; color: #ccc; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
.ev-price { flex: 1; text-align: right; color: #e0e0e0; }
.ev-chg { flex: 1; text-align: right; font-weight: 600; }
...
.hs-cal-item { display: flex; align-items: center; gap: 8px; padding: 3px 0; font-size: 16px; }
.hs-cal-date { color: #888; width: 76px; flex-shrink: 0; font-size: 16px; }
.hs-cal-title { flex: 1; color: #e0e0e0; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; font-size: 16px; }
.hs-cal-empty { font-size: 16px; color: #555; padding: 6px 0; }
.cal-price { width: 60px; text-align: right; color: #4fc3f7; font-size: 16px; flex-shrink: 0; }
.cal-status { width: 56px; text-align: right; font-size: 16px; padding: 1px 6px; border-radius: 3px; flex-shrink: 0; }
...
.hs-news-time { color: #888; width: 76px; flex-shrink: 0; font-size: 16px; line-height: 16px; }
.hs-news-title { flex: 1; color: #ccc; font-size: 16px; line-height: 16px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
...
.tag { font-size: 16px; padding: 1px 6px; border-radius: 3px; white-space: nowrap; }
...
.sector-label { font-size: 16px; color: #555; padding: 1px 0; }
.sector-tag { font-size: 16px; padding: 1px 6px; border-radius: 3px; background: rgba(179,136,255,0.15); color: #b388ff; white-space: nowrap; }
.stock-tag { font-size: 16px; padding: 1px 6px; border-radius: 3px; background: rgba(255,152,0,0.15); color: #FF9800; font-family: monospace; }
.empty { text-align: center; padding: 30px; color: #555; font-size: 16px; }
...
.modal {
  background: #1a1a2e; border-radius: 10px; padding: 24px; width: 85%; max-width: 360px;
  text-align: center;
}
.modal-header { font-size: 16px; font-weight: 600; color: #e0e0e0; margin-bottom: 12px; }
.modal-body { font-size: 14px; color: #ccc; line-height: 1.5; margin-bottom: 20px; word-break: break-all; }
.modal-close {
  padding: 10px 32px; border-radius: 8px; border: none;
  background: #FF4D4F; color: #fff; font-size: 15px; cursor: pointer;
}
...
.legend {
  margin-top: 8px; padding: 6px 12px; font-size: 16px; color: #666;
