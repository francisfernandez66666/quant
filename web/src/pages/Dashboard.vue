...
.stat-label { font-size: 16px; color: #888; margin-top: 2px; }
.grid-2col { display: grid; grid-template-columns: 1fr 1fr; gap: 16px; }
@media (max-width: 768px) {
  .grid-2col { grid-template-columns: 1fr; }
  .stats-row { gap: 8px; }
  .stats-row .stat-num { font-size: 28px; }
  .stock-table { font-size: 16px; }
  .st-code { width: 80px; }
  .st-price { width: 90px; }
  .st-chg { width: 80px; }
}
.card { background: #1a1a2e; border-radius: 8px; padding: 14px; }
.card-header { display: flex; align-items: center; justify-content: space-between; font-size: 16px; font-weight: 600; color: #ccc; margin-bottom: 10px; }
.card-sub { font-size: 16px; color: #666; font-weight: 400; }
.badge-live { font-size: 16px; background: #FF4D4F; color: #fff; padding: 1px 6px; border-radius: 3px; margin-left: 6px; animation: pulse 2s infinite; }
@keyframes pulse { 0% { opacity: 1; } 50% { opacity: 0.5; } 100% { opacity: 1; } }

.stock-table { font-size: 16px; overflow-x: auto; }
.st-header, .st-row { display: flex; align-items: center; padding: 4px 0; gap: 6px; min-width: 320px; }
...
.cal-item { display: flex; align-items: center; gap: 8px; padding: 3px 0; font-size: 16px; }
.cal-date { color: #888; width: 76px; flex-shrink: 0; font-size: 16px; }
.cal-title { flex: 1; color: #e0e0e0; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; font-size: 16px; line-height: 16px; }
.cal-empty { font-size: 16px; color: #555; padding: 6px 0; }
...
.sec-row { display: flex; align-items: center; gap: 10px; padding: 4px 0; font-size: 16px; border-bottom: 1px solid #1f1f30; }
...
.news-time { color: #888; width: 76px; flex-shrink: 0; font-size: 16px; line-height: 16px; }
.news-title-text { flex: 1; color: #ccc; font-size: 16px; line-height: 16px; }
.news-tags-line { display: flex; gap: 4px; flex-wrap: wrap; margin-top: 3px; margin-left: 84px; min-height: 16px; }
.tag { font-size: 16px; padding: 1px 6px; border-radius: 3px; }
...
.sector-tag { font-size: 16px; padding: 1px 6px; border-radius: 3px; background: rgba(179,136,255,0.15); color: #b388ff; }
...
.status-row-inline { display: flex; gap: 20px; font-size: 16px; color: #666; flex-wrap: wrap; }
</style>
