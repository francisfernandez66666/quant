...
.badge-level { font-size: 16px; padding: 1px 8px; border-radius: 4px; font-weight: 600; }
.msg-stock { font-size: 16px; color: #4fc3f7; font-family: monospace; font-weight: 600; }
...
.msg-time { font-size: 16px; color: #555; flex: 1; }
.badge-action { font-size: 16px; padding: 1px 8px; border-radius: 4px; }
...
.msg-title { font-size: 16px; color: #e0e0e0; font-weight: 600; }
.msg-body { font-size: 16px; color: #999; margin-top: 4px; }
.msg-footer { display: flex; gap: 12px; margin-top: 8px; }
.msg-code { font-size: 16px; color: #4fc3f7; font-family: monospace; }
.msg-name { font-size: 16px; color: #888; }
